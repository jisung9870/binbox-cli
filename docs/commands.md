...
| Secrets | `sec init/list/set/get/copy/env/rm` | Search-first service/field TUI without secret values; existing age key/ciphertext format; plaintext remains in memory or pipes |
